...
import { capitalizeFirstLetter, formatPrice, numberWithCommas, getUserQuantityOwned } from '../../utilities/helpers';
        ...
        if (quantity === 0) {
            ...
            try {
                ...
                handleBannerMessage(
                    ...
                    `Purchased ${numberWithCommas(quantity)} ${crypto.ticker.toUpperCase()} coin${
                        quantity > 1 ? 's' : ''
                    }`
                );
                handleClose();
            ...
            >
                ...
                <div className='priceOverview'>
                    <div className='cryptoDetails'>
                        <Avatar sx={{ border: 'solid black 1px' }} aria-label='crypto' src={crypto.image} />
                    ...
                    <div className='balanceDetails'>
                        ...
                        <div className='balance'>
                            ...
                            <p>${user?.balance && numberWithCommas(formatPrice(user?.balance))}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='currentlyOwnedInfo'>
                    {ownedQuantity > 0 ? (
                        <p>
                            You currently own
                            {` ${ownedQuantity} ${crypto.name}${ownedQuantity > 1 ? 's' : ''} coin${
                                ownedQuantity > 1 ? 's' : ''
                            }.`}
                        </p>
                    ) : (
                ...
                <div className='checkoutDetails'>
                    ...
                    <p className='totalCalculation'>
                        Total: ${isNaN(quantity) ? 0 : numberWithCommas(quantity * crypto.price)}
                    </p>
                </div>
                ...
                <p style={{ fontSize: '10px', paddingTop: '2.5px' }}>
                    transactions are made with real-time prices, above values are estimated and not final
                </p>
