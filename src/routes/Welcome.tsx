...
import { WelcomePageWrapper, IntroCardWrapper, FeaturesWrapper } from '../components/styled';
        ...
        <WelcomePageWrapper>
            ...
            <FeaturesWrapper theme={theme.palette.mode}>
                ...
                <div className='expandedInfo animate__animated animate__fadeIn'>
                    ...
                    {cryptos.length > 0 && <p className='intro'>Invest in some of the worlds most popular cryptos!</p>}
                    <ul>
